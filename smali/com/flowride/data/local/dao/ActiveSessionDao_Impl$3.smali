.class Lcom/flowride/data/local/dao/ActiveSessionDao_Impl$3;
.super Lx3/k;
.source "SourceFile"
...
.method public constructor <init>(Lcom/flowride/data/local/dao/ActiveSessionDao_Impl;Lx3/e0;)V
    ...
    iput-object p1, p0, Lcom/flowride/data/local/dao/ActiveSessionDao_Impl$3;->this$0:Lcom/flowride/data/local/dao/ActiveSessionDao_Impl;
...
.method public bridge synthetic bind(Lc4/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/flowride/data/local/dao/ActiveSessionDao_Impl$3;->bind(Lc4/i;Lcom/flowride/data/local/entity/ActiveSessionEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `active_session` SET `user_id` = ?,`session_id` = ?,`device_id` = ?,`started_at` = ?,`auto_stop_at` = ?,`is_active` = ?,`last_synced_at` = ? WHERE `user_id` = ?"
