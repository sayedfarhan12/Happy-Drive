.class Lcom/flowride/data/local/dao/ZoneDao_Impl$3;
.super Lx3/k;
.source "SourceFile"
...
.method public constructor <init>(Lcom/flowride/data/local/dao/ZoneDao_Impl;Lx3/e0;)V
    ...
    iput-object p1, p0, Lcom/flowride/data/local/dao/ZoneDao_Impl$3;->this$0:Lcom/flowride/data/local/dao/ZoneDao_Impl;
...
.method public bridge synthetic bind(Lc4/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/flowride/data/local/dao/ZoneDao_Impl$3;->bind(Lc4/i;Lcom/flowride/data/local/entity/ZoneEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `zones` SET `zone_id` = ?,`user_id` = ?,`name` = ?,`type` = ?,`polygon_json` = ?,`is_active` = ?,`updated_at` = ?,`color` = ?,`is_starred` = ?,`sort_order` = ? WHERE `zone_id` = ?"
