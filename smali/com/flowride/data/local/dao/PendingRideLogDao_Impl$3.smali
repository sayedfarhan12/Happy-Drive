.class Lcom/flowride/data/local/dao/PendingRideLogDao_Impl$3;
.super Lx3/k;
.source "SourceFile"
...
.method public constructor <init>(Lcom/flowride/data/local/dao/PendingRideLogDao_Impl;Lx3/e0;)V
    ...
    iput-object p1, p0, Lcom/flowride/data/local/dao/PendingRideLogDao_Impl$3;->this$0:Lcom/flowride/data/local/dao/PendingRideLogDao_Impl;
...
.method public bridge synthetic bind(Lc4/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/flowride/data/local/dao/PendingRideLogDao_Impl$3;->bind(Lc4/i;Lcom/flowride/data/local/entity/PendingRideLogEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `pending_ride_logs` SET `local_id` = ?,`idempotency_key` = ?,`provider` = ?,`action` = ?,`ride_price` = ?,`ride_distance` = ?,`pickup_text` = ?,`destination_text` = ?,`ocr_confidence` = ?,`decision_ms` = ?,`device_id_hash` = ?,`filter_id` = ?,`rejection_reason` = ?,`created_at` = ?,`is_synced` = ?,`retry_count` = ?,`last_error` = ? WHERE `local_id` = ?"
