.class Lcom/flowride/data/local/dao/BehaviorSettingsDao_Impl$3;
.super Lx3/k;
.source "SourceFile"
...
.method public constructor <init>(Lcom/flowride/data/local/dao/BehaviorSettingsDao_Impl;Lx3/e0;)V
    ...
    iput-object p1, p0, Lcom/flowride/data/local/dao/BehaviorSettingsDao_Impl$3;->this$0:Lcom/flowride/data/local/dao/BehaviorSettingsDao_Impl;
...
.method public bridge synthetic bind(Lc4/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/flowride/data/local/dao/BehaviorSettingsDao_Impl$3;->bind(Lc4/i;Lcom/flowride/data/local/entity/BehaviorSettingsEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `behavior_settings` SET `user_id` = ?,`accept_delay_min_ms` = ?,`accept_delay_max_ms` = ?,`reject_delay_min_ms` = ?,`reject_delay_max_ms` = ?,`negotiate_delay_min_ms` = ?,`negotiate_delay_max_ms` = ?,`cooldown_after_accept_s` = ?,`daily_auto_stop_hours` = ?,`max_consecutive_rejects` = ?,`break_after_rejects_s` = ?,`enable_gesture_random` = ?,`enable_fake_scroll` = ?,`enable_random_pause` = ?,`fetched_at` = ? WHERE `user_id` = ?"
