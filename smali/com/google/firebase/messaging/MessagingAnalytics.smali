...
.method public static getInstanceId(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lba/c;->c()Ls8/u;
...
.method public static getProjectNumber(Landroid/os/Bundle;)J
    ...
    iget-object v0, p0, Lo9/h;->c:Lo9/j;

    iget-object v1, v0, Lo9/j;->e:Ljava/lang/String;
...
.method public static logNotificationReceived(Landroid/content/Intent;)V
    ...
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()Lk7/g;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/MessagingAnalytics;->logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lk7/g;)V

    :cond_1
    return-void
.end method

.method private static logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lk7/g;)V
    .locals 5
    ...
    invoke-direct {v1, p1}, Lk7/b;-><init>(Ljava/lang/Integer;)V
    ...
    invoke-direct {v3, v2}, Lk7/c;-><init>(Ljava/lang/String;)V

    new-instance v2, La9/p;

    const/4 v4, 0x2

    invoke-direct {v2, v4}, La9/p;-><init>(I)V

    check-cast p2, Ln7/q;

    invoke-virtual {p2, p1, v3, v2}, Ln7/q;->a(Ljava/lang/String;Lk7/c;Lk7/f;)Ln7/r;
    ...
    invoke-direct {p2, p0, v2, v1}, Lk7/a;-><init>(Ljava/lang/Object;Lk7/e;Lk7/b;)V

    invoke-virtual {p1, p2}, Ln7/r;->a(Lk7/d;)V
    :try_end_0
...
.method public static logToScion(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1}, Lr9/c;->a(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private static setUserPropertyIfRequired(Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, v2}, Lr9/c;->a(Ljava/lang/Class;)Ljava/lang/Object;
