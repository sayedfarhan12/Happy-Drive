...
.field private static wakeLock:Lr8/a;
...
.method public static synthetic a(Landroid/content/Intent;Ls8/k;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/WakeLockHolder;->lambda$sendWakefulServiceIntent$0(Landroid/content/Intent;Ls8/k;)V
...
.method public static acquireWakeLock(Landroid/content/Intent;J)V
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;
    ...
    sget-object p0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;

    invoke-virtual {p0, p1, p2}, Lr8/a;->a(J)V
...
.method private static checkAndInitWakeLock(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;

    if-nez v0, :cond_0

    new-instance v0, Lr8/a;

    invoke-direct {v0, p0}, Lr8/a;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;

    iget-object p0, v0, Lr8/a;->a:Ljava/lang/Object;
...
.method private static synthetic lambda$sendWakefulServiceIntent$0(Landroid/content/Intent;Ls8/k;)V
    .locals 0
...
.method public static reset()V
    ...
    :try_start_0
    sput-object v1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;
...
.method public static sendWakefulServiceIntent(Landroid/content/Context;Lcom/google/firebase/messaging/WithinAppServiceConnection;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v1, v2}, Lr8/a;->a(J)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p1, p2}, Lcom/google/firebase/messaging/WithinAppServiceConnection;->sendIntent(Landroid/content/Intent;)Ls8/k;
    ...
    invoke-direct {p1, p2, v1}, Lcom/google/firebase/messaging/f;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p0, p1}, Ls8/k;->b(Ls8/f;)Ls8/u;
...
.method public static startWakefulService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    sget-object p1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lr8/a;

    sget-wide v1, Lcom/google/firebase/messaging/WakeLockHolder;->WAKE_LOCK_ACQUIRE_TIMEOUT_MILLIS:J

    invoke-virtual {p1, v1, v2}, Lr8/a;->a(J)V
