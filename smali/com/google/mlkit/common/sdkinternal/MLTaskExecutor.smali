...
.method public scheduleCallable(Ljava/util/concurrent/Callable;)Ls8/k;
    .locals 2
    ...
    invoke-direct {v1, p1, v0}, Lcom/google/mlkit/common/sdkinternal/zzf;-><init>(Ljava/util/concurrent/Callable;Ls8/l;)V
...
.method public scheduleTaskCallable(Ljava/util/concurrent/Callable;)Ls8/k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<ResultT:",
    ...
    invoke-virtual {p0, p1}, Lcom/google/mlkit/common/sdkinternal/MLTaskExecutor;->scheduleCallable(Ljava/util/concurrent/Callable;)Ls8/k;
    ...
    invoke-virtual {p1, v0, v1}, Ls8/k;->f(Ljava/util/concurrent/Executor;Ls8/c;)Ls8/u;
