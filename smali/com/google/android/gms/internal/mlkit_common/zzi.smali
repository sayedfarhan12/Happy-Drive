...
.method private static zzi(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;Lcom/google/android/gms/internal/mlkit_common/zzh;)V
    ...
    invoke-static {p0}, Lr2/h;->getDataDir(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_1
    invoke-static {p0}, Lr2/h;->createDeviceProtectedStorageContext(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-static {p1}, Lr2/h;->getDataDir(Landroid/content/Context;)Ljava/io/File;
