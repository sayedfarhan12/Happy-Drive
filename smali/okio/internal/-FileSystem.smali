...
# direct methods
.method public static final collectRecursively(Ljb/l;Lokio/FileSystem;Lqa/n;Lokio/Path;ZZLta/e;)Ljava/lang/Object;
    .locals 16
    ...
    invoke-direct {v4, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Lta/e;)V
    ...
    invoke-virtual {v0, v1, v4}, Ljb/l;->c(Ljava/lang/Object;Lta/e;)V
    ...
    invoke-virtual {v6, v13}, Lqa/n;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v2, v1}, Lf0/a;->i(Ljava/lang/String;Lokio/Path;)Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v6, v13}, Lqa/n;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->collectRecursively(Ljb/l;Lokio/FileSystem;Lqa/n;Lokio/Path;ZZLta/e;)Ljava/lang/Object;
    ...
    :cond_b
    invoke-virtual {v8}, Lqa/n;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Ljb/l;->c(Ljava/lang/Object;Lta/e;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    invoke-static {p0, p1}, Lj8/a;->K(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lqa/n;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lta/e;)V

    new-instance p1, Lqa/r;

    const/4 v1, 0x2

    invoke-direct {p1, v0, v1}, Lqa/r;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1}, Lqa/r;->iterator()Ljava/util/Iterator;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Ljb/j;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLta/e;)V

    new-instance p0, Lqa/r;

    const/4 p1, 0x2

    invoke-direct {p0, v0, p1}, Lqa/r;-><init>(Ljava/lang/Object;I)V
