...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct/range {v5 .. v20}, Lokio/internal/ZipEntry;-><init>(Lokio/Path;ZLjava/lang/String;JJJILjava/lang/Long;JILcb/f;)V

    new-instance v2, Lpa/g;

    invoke-direct {v2, v0, v1}, Lpa/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v2}, [Lpa/g;

    move-result-object v0

    new-instance v1, Ljava/util/LinkedHashMap;

    invoke-static {v3}, Lt7/e;->i(I)I

    move-result v2

    invoke-direct {v1, v2}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {v1, v0}, Lqa/z;->E(Ljava/util/HashMap;[Lpa/g;)V
    ...
    invoke-static {v2, v0}, Lqa/s;->O1(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-direct/range {v4 .. v19}, Lokio/internal/ZipEntry;-><init>(Lokio/Path;ZLjava/lang/String;JJJILjava/lang/Long;JILcb/f;)V
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lbb/c;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_5
    invoke-static {v5, v11}, Lr7/d;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :goto_2
    :try_start_9
    invoke-static {v3, v11}, Lr7/d;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    invoke-static {v4, v11}, Lr7/d;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, Lr7/d;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lbb/c;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipFilesKt;->openZip(Lokio/Path;Lokio/FileSystem;Lbb/c;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v6, v2}, Lkb/l;->k1(Ljava/lang/CharSequence;C)Z
    ...
    invoke-direct/range {v0 .. v7}, Lokio/internal/ZipFilesKt$readEntry$1;-><init>(Lcb/q;JLcb/t;Lokio/BufferedSource;Lcb/t;Lcb/t;)V

    invoke-static {v8, v12, v15}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILbb/e;)V

    cmp-long v0, v9, v16

    if-lez v0, :cond_4

    iget-boolean v0, v14, Lcb/q;->k:Z
    ...
    invoke-static {v11, v1, v4}, Lkb/l;->m1(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget-wide v2, v2, Lcb/t;->k:J

    move-object/from16 v4, v25

    iget-wide v4, v4, Lcb/t;->k:J

    move-object/from16 v6, v26

    iget-wide v6, v6, Lcb/t;->k:J
...
.method private static final readExtra(Lokio/BufferedSource;ILbb/e;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lbb/e;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    :goto_0
    iput-object v3, v1, Lcb/u;->k:Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v1, v3, v4}, Lokio/internal/ZipFilesKt$readOrSkipLocalHeader$1;-><init>(Lokio/BufferedSource;Lcb/u;Lcb/u;Lcb/u;)V

    invoke-static {v0, v5, v2}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILbb/e;)V
    ...
    invoke-direct/range {v6 .. v16}, Lokio/FileMetadata;-><init>(ZZLokio/Path;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILcb/f;)V
